              ...
              <>
                <div className="table-scroll">
                  <table className="data-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><b>연무초 늘봄</b><br /><span style={{ color: '#8f9c93', fontSize: 11 }}>비교집단 · 5학년</span></td>
                        <td colSpan={6} style={{ color: '#8f9c93' }}>
                          프로파일링 미적용 — 사전검사 결과와 무관하게 이미 짜여 있는 "마음
                          레벨업" 고정형 커리큘럼을 그대로 운영했다. 강점·취약 영역 산출, 권장
                          과정 매핑 모두 해당 없음.
                        </td>
                      </tr>
                      <tr>
                ...
                <div className="box-grid">
                  ...
                  <div className="info-box info-box--leaf">
                    <h4>양촌·보건소가 겹친 지점</h4>
                    <p>
                      프로파일링을 거친 두 집단(연무초는 미적용) 모두 <b>긍정적 관계 맺기</b>가
                      취약으로 잡혔고 두 현장 모두 최다 회기를 배정했다. 다루는 방식은 갈렸다.
                      양촌은 강점 인식과 도움 요청으로, 보건소는 부탁하기와 협력으로 들어갔다.
                    </p>
                  </div>
                </div>
